...
describe World do
    ...
    it "can create a politician" do
        world = World.new()
        world.create_politician("John Doe", "Rebulican")
  ...
  it "can update a politician record by name" do
      world = World.new()
      world.create_politician("John Doe", "Democrat")
      world.update_politician("John Doe", "name", "Johns Doe")
      expect(world.list_politicians).to eq("Politician, Johns Doe, Democrat")
  end
    ...
    it "can update voter record by politics" do
        world = World.new()
        world.create_voter("John Doe", "Neutral")
